...
<table  border="0" cellpadding="0" cellspacing="0" width="100%"  >
  ...
  <tr>
    ...
    <img src="{{ asset('images/speed.png') }}" alt="Speed" width="300" height="200" style="display: block;" />
    <h1 align="center">¡Estimado Cliente! </h1>
    <img src="{{ asset('images/noti.png') }}" alt="Speed" style="display: block;" />

     </td>
  </tr>
  <tr>
    <td  align="center" bgcolor="#393e46" >
      <h3>Le recordamos su cita del día:</h3>
      <h3>a la hora:</h3>
    </td>
    </td>
